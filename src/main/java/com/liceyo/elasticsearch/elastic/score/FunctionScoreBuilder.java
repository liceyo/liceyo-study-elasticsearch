package com.liceyo.elasticsearch.elastic.score;

import com.liceyo.elasticsearch.elastic.ConstantValue;
import com.liceyo.elasticsearch.elastic.SearchType;
import com.liceyo.elasticsearch.elastic.query.CommonQueryBuilder;
...
//                .calculateTypeWeight()
//                .resultQuery();
        this.query=CommonQueryBuilder.defaultQuery(statement);
    }
